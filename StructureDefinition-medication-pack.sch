...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'nzmtMedicineCode']) &lt;= 1">extension with URL = 'nzmtMedicineCode': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'size']) &lt;= 1">extension with URL = 'size': maximum cardinality of 'extension' is 1</sch:assert>
