...
public class GetFundingByInstance(FhirClient _client) : IAction<GetFundingByInstance.Parameters>
{
		public async Task Execute(Parameters parameters)
		{
				...
				Console.WriteLine($"Executing GetFundingByInstance action for funding with instance: {parameters.instance}");
				...
				var query = new SearchParams().Add("instance.reference", fullInstance)
					.Add("_profile", "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition-funding-rules");
