# Home - Pharmac Schedules FHIR API v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digital.health.nz/pharmac-schedules/ImplementationGuide/pharmac.fhir.pharmac-schedules | *Version*:0.0.1 |
| Draft as of 2026-03-27 | *Computable Name*:pharmacschedules |
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Community-Pharmacy-BSO-Sequence-1"
      },
      "name" : "ChargeItemDefinition-Community-Pharmacy-BSO-Sequence-1",
      "description" : "Community pharmacy BSO subsidy (Case 1) with provider condition for hospital care operators.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Community-Pharmacy-Rural-PSO-Sequence-1"
      },
      "name" : "ChargeItemDefinition-Community-Pharmacy-Rural-PSO-Sequence-1",
      "description" : "Community pharmacy Rural PSO subsidy (Case 1) with provider condition for authorised prescribers.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Community-Pharmacy-Sequence-1"
      },
      "name" : "ChargeItemDefinition-Community-Pharmacy-Sequence-1",
      "description" : "Community pharmacy prescription subsidy for patients unable to tolerate administration of goserelin. Demonstrates reimbursement with endorsement and provider conditions.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Community-Pharmacy-Sequence-2"
      },
      "name" : "ChargeItemDefinition-Community-Pharmacy-Sequence-2",
      "description" : "Community pharmacy prescription subsidy (Case 2) with provider condition only.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "description" : "Special Authorization SA2139.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-SA2520-Authorization"
      },
      "name" : "ChargeItemDefinition-SA2520-Authorization",
      "description" : "Special Authorization SA2520",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Tenofovir-Case-Sequence-1"
      },
      "name" : "ChargeItemDefinition-Tenofovir-Case-Sequence-1",
      "description" : "Rules for Tenofovir Disoproxil",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Tenofovir-Case-Sequence-2"
      },
      "name" : "ChargeItemDefinition-Tenofovir-Case-Sequence-2",
      "description" : "Rules for Tenofovir Disoproxil",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Lucrin-Depot-1-Month-Pricing"
      },
      "name" : "Lucrin Depot 1-month - Pricing",
      "description" : "Pricing information for Lucrin Depot 1-month (leuprorelin injection). Demonstrates community subsidized pricing with subsidy, alternative pricing, and new pricing attributes including cost brand source, wastage claimable, DV limit percentage, and brand switch fee.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-atc-category-1"
      },
      "name" : "Medication ATC Category 1",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-atc-category-2"
      },
      "name" : "Medication ATC Category 2",
      "description" : "Used to describe ATC Category 2 (including id and name)",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-atc-category-3"
      },
      "name" : "Medication ATC Category 3",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-in-combination"
      },
      "name" : "Medication In Combination",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-original-pack"
      },
      "name" : "Medication Original Pack",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-package-size"
      },
      "name" : "Medication Package Size",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-product-multiple"
      },
      "name" : "Medication Product Multiple",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-product-multiplier"
      },
      "name" : "Medication Product Multiplier",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-rank"
      },
      "name" : "Medication Rank",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-safety-list-medicine"
      },
      "name" : "Medication Safety List Medicine",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-statim"
      },
      "name" : "Medication Statim",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/medication-unit-of-measure"
      },
      "name" : "Medication Unit of Measure",
    ...
    },
    {
      ...
      "name" : "Medication-Lucrin-Depot-1-Month",
      "description" : "Medication representation of Lucrin Depot 1-month (leuprorelin injection).",
    ...
    },
    {
      ...
      "name" : "Medication-Ricovir-Tenofovir",
      "description" : "Medication representation of Ricovir (tenofovir disoproxil tablets).",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-medication"
    },
    {
      "extension" : [{
      ...
      "name" : "Medication-Viramune-Suspension",
      "description" : "Medication representation of Viramune Suspension (nevirapine oral suspension).",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-medication"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "SearchParameter/MedicationBrandNameSearchParam"
      },
      "name" : "MedicationBrandNameSearchParam",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ChargeItemDefinition/ChargeItemDefinition-Ricovir-Pricing"
      },
      "name" : "Ricovir - Pricing",
      "description" : "Pricing information for Ricovir (tenofovir disoproxil tablets). Demonstrates fully subsidized community pricing with PSS contract type and DV limit.",
      "exampleCanonical" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/pharmac-charge-item-definition"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Bundle/SearchSet-Bundle-Leuprorelin-Pricing"
      },
      "name" : "SearchSet-Bundle-Leuprorelin-Pricing",
      "description" : "Example search result demonstrating _include to retrieve Medication resources with their associated ChargeItemDefinition pricing information. This would be the result of a query like: GET /Medication?name=Leuprorelin&_include=ChargeItemDefinition:instance",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "description" : "Example search result demonstrating a bulk medication search.",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Bundle/SearchSet-Bundle-Ricovir-Pricing"
      },
      "name" : "SearchSet-Bundle-Ricovir-Pricing",
      "description" : "Example search result demonstrating _include to retrieve Medication resources with their associated ChargeItemDefinition pricing information. This would be the result of a query like: GET /Medication?name=Tenofovir&_include=ChargeItemDefinition:instance",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Bundle/SearchSet-Bundle-SA2139-Authorization"
      },
      "name" : "SearchSet-Bundle-SA2139-Authorization",
      "description" : "Example search result demonstrating _include to retrieve ChargeItemDefinition resource using the Special Authority ID and it's associated Medication(s)\n        Query: GET /ChargeItemDefinition?code=SA2139&_include=ChargeItemDefinition:instance",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
