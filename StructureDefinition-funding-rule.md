# Funding Rule - Pharmac Schedules FHIR API v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://schedule.pharmac.govt.nz/fhir/StructureDefinition/funding-rule | *Version*:1.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/pharmac.fhir.pharmac-schedules|current/StructureDefinition/StructureDefinition-funding-rule.json)
