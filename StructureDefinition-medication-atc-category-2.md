# Medication ATC Category 2 - Pharmac Schedules FHIR API v0.0.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Medication ATC Category 2**

## Extension: Medication ATC Category 2 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-atc-category-2 | *Version*:0.0.1 |
| Draft as of 2026-03-27 | *Computable Name*:MedicationATCCategory2 |
...
Other representations of profile: [CSV](StructureDefinition-medication-atc-category-2.csv), [Excel](StructureDefinition-medication-atc-category-2.xlsx), [Schematron](StructureDefinition-medication-atc-category-2.sch) 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "Medication ATC Category 2",
      "definition" : "Used to describe ATC Category 2 (including id and name)"
    },
    {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-atc-category-2"
    },
    {
      "id" : "Extension.value[x]",
      "path" : "Extension.value[x]",
      "short" : "ATC Category 2 value",
      "type" : [{
        "code" : "string"
      }]
    }]
