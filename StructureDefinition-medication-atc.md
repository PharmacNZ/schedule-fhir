# Medication ATC - Pharmac Schedules FHIR API v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Medication ATC**

## Extension: Medication ATC 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-atc | *Version*:1.1.0 |
| Draft as of 2026-06-24 | *Computable Name*:MedicationATC |

ATC code and display for the medication.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/pharmac.fhir.pharmac-schedules|current/StructureDefinition/StructureDefinition-medication-atc.json)
...
Other representations of profile: [CSV](StructureDefinition-medication-atc.csv), [Excel](StructureDefinition-medication-atc.xlsx), [Schematron](StructureDefinition-medication-atc.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-atc"
    },
    {
