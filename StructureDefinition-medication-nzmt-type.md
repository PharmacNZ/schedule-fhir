# Medication NZMT Type - Pharmac Schedules FHIR API v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Medication NZMT Type**

## Extension: Medication NZMT Type 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-nzmt-type | *Version*:1.1.0 |
| Draft as of 2026-06-24 | *Computable Name*:MedicationNZMTType |

NZMT concept type for the medication code (for example CTPP).
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/pharmac.fhir.pharmac-schedules|current/StructureDefinition/StructureDefinition-medication-nzmt-type.json)
...
Other representations of profile: [CSV](StructureDefinition-medication-nzmt-type.csv), [Excel](StructureDefinition-medication-nzmt-type.xlsx), [Schematron](StructureDefinition-medication-nzmt-type.sch) 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "Medication NZMT Type",
      "definition" : "NZMT concept type for the medication code (for example CTPP)."
    },
    {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-nzmt-type"
    },
    {
      "id" : "Extension.value[x]",
      "path" : "Extension.value[x]",
      "short" : "NZMT type code",
      "type" : [{
