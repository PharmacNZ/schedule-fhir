# Medication Description - Pharmac Schedules FHIR API v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Medication Description**

## Extension: Medication Description 

| | |
| :--- | :--- |
| *Official URL*:https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-description | *Version*:1.1.0 |
| Draft as of 2026-06-24 | *Computable Name*:MedicationDescription |

Structured description fields for medication terms.
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/pharmac.fhir.pharmac-schedules|current/StructureDefinition/StructureDefinition-medication-description.json)
...
Other representations of profile: [CSV](StructureDefinition-medication-description.csv), [Excel](StructureDefinition-medication-description.xlsx), [Schematron](StructureDefinition-medication-description.sch) 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Structured description fields for medication terms."
    },
    {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://fhir-ig.digital.health.nz/pharmac-schedules/StructureDefinition/medication-description"
    },
    {
